...
exports.execute = async (bot, msg) => {
  ...
  const embed = new MessageEmbed()
    .setDescription(`Neue gelöschte Nachricht von ${msg.member} in ${msg.channel}`)
    .addField("Inhalt der gelöschten Nachricht", msg.content ? msg.content : "Diese Nachricht hatte keinen Inhalt.");
